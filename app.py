# app.py – Gym Bro X (sticky top nav, robust AI, all features)
...
# ============================================
# GYM BRO CLASS (unchanged – full power)
# ============================================
class GymBro:
...
# ---------- Sticky Top Navigation (using buttons) ----------
st.markdown("""
<style>
.sticky-nav {
    position: sticky;
...
if page == "👤 Profile":
    ...
    if st.session_state.get("edit_profile"):
        with st.form("edit_profile_form"):
            # (full edit form – identical to previous)
            pass  # Paste the full edit form here
    ...
    # (workout logger – identical to previous)
    pass
    ...
    # (AI chat with robust JSON handling)
    pass